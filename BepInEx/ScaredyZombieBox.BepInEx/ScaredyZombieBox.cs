...
namespace ScaredyZombieBox.BepInEx
{
    ...
    public class Core : BasePlugin
    {
        public override void Load()
        {
            ...
            var ab = CustomCore.GetAssetBundle(Assembly.GetExecutingAssembly(), "scaredyzombiebox" + (Application.platform == RuntimePlatform.Android ? ".android" : ""));
            CustomCore.RegisterCustomPlant<ScaredyShroom, ScaredyZombieBox>(390, ab.GetAsset<GameObject>("ScaredyZombieBoxPrefab"),
